...
class _MinigameCuidadosState extends State<MinigameCuidados> {
  ...
  void _gerarPosicoes() {
    sujeiras = List.generate(3, (_) => Offset(100 + random.nextDouble() * 200, 160 + random.nextDouble() * 200));
    folhas = List.generate(3, (_) => Offset(80 + random.nextDouble() * 240, 150 + random.nextDouble() * 200));
    galhos = List.generate(2, (_) => Offset(90 + random.nextDouble() * 100, 300 + random.nextDouble() * 80));
    machucados = List.generate(2, (_) => Offset(140 + random.nextDouble() * 180, 180 + random.nextDouble() * 150));
  }
  ...
  void _aplicarBanho() { if (!banhoFeito) { setState(() { sujeiras.clear(); banhoFeito = true; }); _verificarConclusao(); } }
  void _aplicarFolha() { if (!folhasFeito) { setState(() { folhas.clear(); folhasFeito = true; }); _verificarConclusao(); } }
  void _aplicarGalho() { if (!galhosFeito) { setState(() { galhos.clear(); galhosFeito = true; }); _verificarConclusao(); } }
  void _aplicarPomada() { if (!pomadaFeito) { setState(() { machucados.clear(); pomadaFeito = true; }); _verificarConclusao(); } }
  void _aplicarPente() { if (!penteFeito) { setState(() { penteFeito = true; }); _verificarConclusao(); } }
  void _aplicarLacinho() { if (!lacinhoFeito) { setState(() { lacinhoFeito = true; }); _verificarConclusao(); } }
          ...
          children: [
            ...
            Center(
              child: Column(
                ...
                children: [
                  Image.asset('assets/personagens/manacas/capivara_bem.png', height: 300, errorBuilder: (_, __, ___) => Icon(Icons.pets, size: 150)),
                  SizedBox(height: 30),
                  ElevatedButton(
        ...
        children: [
          ...
          Center(
            child: DragTarget<String>(
              ...
              builder: (context, candidateData, rejectedData) {
                return Stack(
                  children: [
                    Image.asset('assets/personagens/manacas/capivara_machucada.png', height: 400, errorBuilder: (_, __, ___) => Container(height: 400, color: Colors.brown)),
                    ...sujeiras.map((pos) => Positioned(left: pos.dx, top: pos.dy, child: Image.asset('assets/personagens/manacas/sujeira.png', width: 35, height: 35))),
                    ...folhas.map((pos) => Positioned(left: pos.dx, top: pos.dy, child: Image.asset('assets/personagens/manacas/folha.png', width: 35, height: 35))),
                    ...galhos.map((pos) => Positioned(left: pos.dx, top: pos.dy, child: Image.asset('assets/personagens/manacas/galho.png', width: 35, height: 35))),
                    ...machucados.map((pos) => Positioned(left: pos.dx, top: pos.dy, child: Image.asset('assets/personagens/manacas/machucado.png', width: 35, height: 35))),
                  ],
                );
              },
            ),
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: Color.fromRGBO(38, 23, 23, 0.9),
        ...
        child: Column(
          children: [
            Container(
              ...
              child: ClipRRect(borderRadius: BorderRadius.circular(16), child: Image.asset(asset, fit: BoxFit.cover)),
            ),
